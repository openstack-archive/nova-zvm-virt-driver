...
from nova_zvm.virt.zvm import exception as zvm_exception
...
class TestZVMDriver(test.NoDBTestCase):
    ...
    def setUp(self):
        ...
        with mock.patch('nova_zvm.virt.zvm.utils.ConnectorClient.call') as mcall, \
    ...
    def test_driver_init_no_url(self):
        ...
        self.assertRaises(zvm_exception.ZVMDriverException,
    ...
    def test_get_available_resource_err_case(self, call):
        ...
        call.side_effect = zvm_exception.ZVMConnectorError(res)
    ...
    def test_private_get_image_info_err(self, call):
        ...
        call.side_effect = zvm_exception.ZVMConnectorError(res)
        self.assertRaises(zvm_exception.ZVMConnectorError,
    ...
    def test_private_get_image_info(self, image_import, call):
        ...
        call_response = []
        call_response.append(zvm_exception.ZVMConnectorError(results=res))
    ...
    @mock.patch('nova_zvm.virt.zvm.hypervisor.Hypervisor.guest_exists')
    @mock.patch('nova_zvm.virt.zvm.utils.ConnectorClient.call')
    ...
    @mock.patch('nova_zvm.virt.zvm.utils.generate_configdrive')
    ...
    @mock.patch('nova.image.glance.get_remote_image_service')
    @mock.patch('nova_zvm.virt.zvm.hypervisor.Hypervisor.guest_capture')
    def test_snapshot_capture_fail(self, mock_capture, get_image_service):
        image_service = mock.Mock()
        image_id = 'e9ee1562-3ea1-4cb1-9f4c-f2033000eab1'
        get_image_service.return_value = (image_service, image_id)
        mock_capture.side_effect = zvm_exception.ZVMDriverException(
                                                                error='error')
    ...
    @mock.patch('nova.image.glance.get_remote_image_service')
    @mock.patch('nova_zvm.virt.zvm.utils.ConnectorClient.call')
    @mock.patch('nova_zvm.virt.zvm.hypervisor.Hypervisor.image_delete')
    @mock.patch('nova_zvm.virt.zvm.hypervisor.Hypervisor.image_export')
    def test_snapshot_import_fail(self, mock_import, mock_delete,
        ...
        mock_import.side_effect = zvm_exception.ZVMDriverException(
                                                                error='error')
    ...
    @mock.patch('nova_zvm.virt.zvm.hypervisor.Hypervisor.guest_start')
    ...
    @mock.patch('nova_zvm.virt.zvm.hypervisor.Hypervisor.guest_softstop')
    ...
    @mock.patch('nova_zvm.virt.zvm.hypervisor.Hypervisor.guest_pause')
    def test_pause(self, ipa):
        self._driver.pause(self._instance)
        ipa.assert_called_once_with(self._instance.name)

    @mock.patch('nova_zvm.virt.zvm.hypervisor.Hypervisor.guest_unpause')
    def test_unpause(self, ipa):
        self._driver.unpause(self._instance)
        ipa.assert_called_once_with(self._instance.name)

    @mock.patch('nova_zvm.virt.zvm.hypervisor.Hypervisor.guest_reboot')
    def test_reboot_soft(self, ipa):
        self._driver.reboot(None, self._instance, None, 'SOFT')
        ipa.assert_called_once_with(self._instance.name)

    @mock.patch('nova_zvm.virt.zvm.hypervisor.Hypervisor.guest_reset')
