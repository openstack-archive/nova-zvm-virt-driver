...
class TestZVMUtils(test.NoDBTestCase):
    ...
    def test_connector_request_handler_invalid_url(self):
        ...
        self.assertRaises(zvm_exception.ZVMDriverException, rh.call,
                          'guest_list')
    ...
    def test_connector_request_handler_error(self, mock_send):
        ...
        rh = zvmutils.ConnectorClient(self._url)
        exc = self.assertRaises(zvm_exception.ZVMConnectorError, rh.call,
                                'guest_list')
    ...
    @mock.patch('nova_zvm.virt.zvm.utils._get_instance_path')
