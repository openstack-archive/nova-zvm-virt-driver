...
class ZVMDriver(driver.ComputeDriver):
    ...
    def _validate_options():
        if not CONF.zvm.cloud_connector_url:
            ...
            raise zvm_exception.ZVMDriverException(error=error)
        ...
        try:
            ...
            raise zvm_exception.ZVMDriverException(error=msg)
    ...
    def instance_exists(self, instance):
        ...
        return instance.name.upper() in self.list_instances()
    ...
    def _get_image_info(self, context, image_meta_id, os_distro):
        ...
        except zvm_exception.ZVMConnectorError as err:
