...
class ZVMDriverTestCases(ZVMTestCase):
    ...
    def test_spawn(self):
        ...
        self.stubs.Set(self.driver, '_wait_and_get_nic_switch',
                       self._fake_fun())
        self.stubs.Set(self.driver, '_add_nic_to_instance',
                       self._fake_fun())
    ...
    def test_spawn_with_eph_opts(self):
        ...
        self.driver._add_nic_to_instance('os000001', fake)
...
class ZVMNetworkTestCases(ZVMTestCase):
    ...
    def test_add_instance_nic(self):
        ...
        self.networkop._add_instance_nic('fakehcp', self.iname, '1000',
                                          'fake', 'fake')
        self.mox.VerifyAll()
